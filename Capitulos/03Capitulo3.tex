...
Para mejorar las probabilidades de encontrar estrellas variables y objetos transientes, una imagen de mediana de 
...
(flat-field o fallos en la PSF modelada).
...
ISIS construye esta imagen de mediana de diferenicias y el archivo 
...
de acuerdo a un threshold (\texttt{SIG\_THRESH}) 
...
Los parametros fotométricos del proceso como el radio de apertura (\texttt{rad\_aper}) 
