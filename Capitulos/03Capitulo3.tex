...
\subsection{Registro de imágenes}
%-------------------------------------------------------------------
...
%hacer que el conjunto de observaciones coincidan en %sus características más generales
%el campo observado y la malla de coordenadas 
%, esto es, 
%alinearlas 
alinear las observaciones 
al mismo sistema de referencia, de 
...
La imagen elegida se indica como \texttt{REFERENCE} en el archivo \texttt{process\_config}.
Una observación a tomar en cuenta para beneficio 
...
grado del polinomio bidimensional %\texttt{process\_config/DEGREE} 
correspondiente 
...
rápido \citep{alard-old-registration}. 
...
El grado del polinomio de transformación astrométrica se define mediante 
el parámetro \texttt{DEGREE} en el archivo \texttt{process\_config}.
...
a lo largo de todas las imágenes será filtrado mediante \textit{3 sigma 
