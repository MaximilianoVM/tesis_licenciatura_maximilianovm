...
cuya intensidad varía con el tiempo, como ocurre en eventos transientes y estrellas variables.
...
Un paso fundamental previo a la sustraccion de imágenes es el registro e interpolación astrométrica 
...
un metodo que utiliza un total de 16 ($4x4=$) píxeles adyacentes para lograr una 
interpolacion con un resultado mas suavizado que con una implementación lineal \citep{Xia_2013}. 
...
"la imagen de referencia es aquella que se sustraera o se vera sustraida dependiendo del paquete 
con cada una de las imágenes de ciencia, siendo los residulos de cada una de estas restas 
representativos de la variacion de los objetos en la imagen respecto al momento fijo de la imagen 
de referencia. 

Esta imagen debe tener la caracteristica de ser la de mejor calidad entre todas. Para posteriormente 
ser degradada por medio de la convolucion con el kernel para coincidir con las condiciones de la imagen de ciencia correspondiente. 
Se puede elegir una imagen especifica de nuestro conjunto o bien se puede construir por medio de un conjunto de imágenes de 
la mejor calidad, como es el caso de ISIS"
...
El proceso de construccion de las curvas de luz se reduce a la estimacion del flujo relativo 
a lo largo de cada una de las imagenes de diferencia en un punto especifico. Dando como resultado 
un archivo que incluye dicho flujo acompañado de la fecha indicada en el archivo DATES correspondiente 
a la imegen. Los puntos sobre los cuales se construyen las curvas de luz son los indicados en el archivo XXX
en el cual se incluyen los nombres de las curvas de luz a generar y las coordenadas physical del objeto.
este archivo es rellenado automaticamente en el paso anterior
 de acuerdo a los puntos indicados sobresalientes en el resultado VAR.FITS del paso anterior. 
